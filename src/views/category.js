    ...
    <div >
      ...
      {categoryStage.map(catStage =>(
        <div key={catStage.idMeal} className="justify-self-center w-56 text-center mt-2">
          ...
          <button onClick={()=>{setIsOpen(false)}} className='absolute border border-black p-2 top-20 right-60 p-2 rounded-lg hover:bg-orange-600 hover:text-white hover:rounded-lg bg-orange-500  font-bold'>Close</button>
